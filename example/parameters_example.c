 ...
 * @LastEditTime   : 2022-08-20 22:56:22
 * @FilePath       : \SparrowSkyFlightControl\SRC\moduldes\Parameters\example\parameters_example.c
 */
...
int main(void)
{
    ...
    Parameters_Creat(&parameters_test, "ABCDEF\0", PARAMETERS_TYPE_F32, &value_1);

    printf("Parameters_Creat out %f\n",
           *((float *)(Parameters_Creat(&parameters_test, "ABCDEF\0", PARAMETERS_TYPE_F32, &value_1))));

    float value_2 = 102.0f;
    Parameters_Creat(&parameters_test, "ABCDEFh\0", PARAMETERS_TYPE_F32, &value_2);

    printf("Parameters_Creat out %f\n",
           *((float *)(Parameters_Creat(&parameters_test, "ABCDEFh\0", PARAMETERS_TYPE_F32, &value_1))));

    float value_3 = 104.0f;
    Parameters_Creat(&parameters_test, "ABCDEFj\0", PARAMETERS_TYPE_F32, &value_3);

    printf("Parameters_Creat out %f\n",
           *((float *)(Parameters_Creat(&parameters_test, "ABCDEFj\0", PARAMETERS_TYPE_F32, &value_1))));
